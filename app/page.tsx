                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                          <div className="space-y-6">
                            ...
                            <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                              The modern way to manage customer credit and track outstanding payments. Perfect for shop
                              owners, small businesses, and anyone who needs professional credit management.
                            </p>
                    ...
                    <Card className="group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20">
                      <CardContent className="pt-8 pb-6 text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                          Add and organize customers with ease. Keep track of all your clients in one centralized
                          location.
                        </p>
                      </CardContent>
                    </Card>
