...
export default function DashboardPage() {
  ...
  useEffect(() => {
    localStorage.setItem("creditkeeper-customers", JSON.stringify(customers))
  }, [customers])

  useEffect(() => {
    localStorage.setItem("creditkeeper-payments", JSON.stringify(paymentHistory))
  }, [paymentHistory])
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {!selectedCustomer && <p className="text-sm text-muted-foreground">Dashboard</p>}
            </div>
          </div>
      ...
      <main className="container mx-auto px-4 py-6">
        <AnimatePresence mode="wait">
          {!selectedCustomer ? (
            ...
            // ... existing customer detail view code ...
            <motion.div
              key="customer-detail"
